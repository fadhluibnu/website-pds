<div class="container-fluid" style="height: 90vh;overflow-y: auto;">
    ...
    <div class="pds-terbaru bg-white box-radius-10 pb-3 mt-3">
        <h1 class="title p-3 pb-1">Need Follow Up</h1>
        <!-- tabel -->
...
<div class="position-absolute modal-custom modal-custom-tinjau off d-flex" id="modal-tinjau-targeted"
            ...
            <form action="" class="mt-3" id="form-setujui">
                <div class="mb-3">
                    ...
                    <div class="d-flex flex-wrap">
                        <input type="checkbox" name="pengendali-dokumen-tinjau" class="d-none btn-check-custom"
                            id="pengendali-dokumen-tinjau">
                        ...
                        <label for="manager-iqa-tinjau" class="btn-checkbox"><i class="bi bi-check-circle-fill"></i>
                            Manager IQA</label>
                        <input type="checkbox" name="manager-urel-tinjau" class="d-none btn-check-custom"
                            id="manager-urel-tinjau">
                        <label for="manager-urel-tinjau" class="btn-checkbox"><i class="bi bi-check-circle-fill"></i>
                            Manager UREL</label>
                        <input type="checkbox" name="manager-deqa-tinjau" class="d-none btn-check-custom"
                            id="manager-deqa-tinjau">
                        <label for="manager-deqa-tinjau" class="btn-checkbox"><i class="bi bi-check-circle-fill"></i>
                            Manager DEQA</label>
                        <input type="checkbox" name="osm-tth-tinjau" class="d-none btn-check-custom"
                            id="osm-tth-tinjau">
                        <label for="osm-tth-tinjau" class="btn-checkbox"><i class="bi bi-check-circle-fill"></i>
                            OSM TTH</label>
                    </div>
                </div>
                ...
                <div class="input-group position-relative mb-3">
                    ...
                    <input type="file" class="form-control fileTinjau position-absolute" id="fileTinjau"
                        aria-describedby="inputGroupFileAddon04" aria-label="Upload" onchange="getNameFile()">
                </div>
                <div class="mb-3">
